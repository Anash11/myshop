...
async function aroles(id,eid){
  let response = await axios.get(`http://localhost:5500/api/admin/getassignrolebyid?id=${id}`);
...
async function activestatus(id){
  let response = await axios.put(`http://localhost:5500/api/admin/userstatusupdate?status=active&id=${id}`);
  console.log(response)
}

async function deactivestatus(id){
  let response = await axios.put(`http://localhost:5500/api/admin/userstatusupdate?status=deactivate&id=${id}`);
  console.log(response)
}
...
async function saveRole(){
  let response = await axios.post(`http://localhost:5500/api/admin/assignroletouser`, {
    "id": neweid,
    "role_id": newRole,
    })
    console.log(response)
...
const StyledInputBase = styled(InputBase)(({ theme }) => ({
  ...
  return (
    <>
    <h1 style={{textAlign:'center', paddingTop:'10px'}}>USERS</h1>
    <div style={{
      display:'flex',
      flexDirection:'row',
